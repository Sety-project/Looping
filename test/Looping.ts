...
describe("Lock", function () {
  async function deployWETHWSTETHFixture() {
    ...
    const lock = await hre.ethers.deployContract("Lock", [asset, base, ltv, slippage],{
  ...
  it("Should constructor", async function () {
    const { lock } = await loadFixture(deployWETHWSTETHFixture);
